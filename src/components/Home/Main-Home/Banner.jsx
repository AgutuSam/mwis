         ...
         <rs-module id="rev_slider_1_1" style={{display: "none"}} data-version="6.2.2">
            <rs-slides>
               <rs-slide data-key="rs-1" data-title="Slide" data-thumb="rev-slider/assets/bg-21-50x100.jpg"
                  ...
                  <img src="rev-slider/assets/bg-21.jpg" title="bg-21.jpg" width="1920" height="1080" alt="banner" className="rev-slidebg"
                     data-no-retina/>
               ...
               <rs-slide data-key="rs-2" data-title="Slide" data-thumb="rev-slider/assets/bg-3343-50x100.jpg"
                  data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:0;">
                  <img src="rev-slider/assets/bg-3343.jpg" title="bg-3343" alt="banner" width="1920" height="1080" className="rev-slidebg"
                     data-no-retina/>
                 {/*  <!--
                     --> */}
                 ...
                 {/*  <!--
                  ...
                  <rs-layer id="slider-1-slide-2-layer-3" data-type="text" data-color="#565969" data-rsp_ch="on"
                     ...
                     data-vbility="t,t,f,f" data-frame_0="x:50,39,29,17;" data-frame_1="st:1200;sp:1000;"
                     data-frame_999="o:0;st:w;" style={style9}>It is a long
                     established
                     fact that a reader will be distracted by the readable content of a<br/>page when looking at its
                     layout.
                  </rs-layer>
                 {/*  <!--
                     --> */}
                       <a href="/aboutus" >                <rs-layer id="slider-1-slide-2-layer-4" href="/aboutme" className="rev-btn" data-type="button" data-rsp_ch="on"
                 ...
                 {/*  <!--
                  ...
                  <rs-layer id="slider-1-slide-2-layer-5" data-type="text" data-color="#ff631b" data-rsp_ch="on"
                     ...
                     data-frame_1="st:600;sp:1000;" data-frame_999="o:0;st:w;"
                     style={style6}>Great Experience in
                     Bulding.
                  </rs-layer>
                 {/*  <!--
                     --> */}
                      <a href="/aboutus" >
                  <rs-layer id="slider-1-slide-2-layer-6" href="/aboutme" className="rev-btn" data-type="button" data-rsp_ch="on"
               ...
               <rs-slide data-key="rs-3" data-title="Slide" data-thumb="rev-slider/assets/bg-333-50x100.jpg"
                  data-anim="ei:d;eo:d;s:600;r:0;t:fade;sl:0;">
                  <img src="rev-slider/assets/bg-333.jpg" alt="banner" title="bg-333" width="1920" height="1080" className="rev-slidebg"
                     data-no-retina/>
               {/*   /*  <!--
                     --> */
                 ...
                 {/*  <!--
                     --> */}
                      <a href="/aboutus" >
                  <rs-layer id="slider-1-slide-3-layer-4" href="/aboutme" className="rev-btn" data-type="button" data-rsp_ch="on"
                 ...
                 {/*  <!--
                     --> */}
                       <a href="/aboutus" >
                  <rs-layer id="slider-1-slide-3-layer-6" href="/aboutme" className="rev-btn" data-type="button" data-rsp_ch="on"
