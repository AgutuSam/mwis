    ...
    <>
     ...
     <Router>
      <Switch>
        ...
        <Route  path="/ThreeColumnswide" exact={true} component={ThreeColumnswide} />
        <Route  path="/FourColumnswide" exact={true} component={FourColumnswide} />

        <Route  path="/portfolioSlider" exact={true} component={PortfolioSlider} />
        <Route  path="/Portfoliogallery" exact={true} component={Portfoliogallery} />
        <Route  path="/Portfoliosingle" exact={true} component={Portfoliosingle} />
        {/* Blog Pages */}
        <Route  path="/onecolumnblog" exact={true} component={Onecolumnblog} />
        <Route  path="/Twocolumnblog" exact={true} component={Twocolumnblog} />
        <Route  path="/Threecolumnblog" exact={true} component={Threecolumnblog} />

        <Route  path="/blogleftsidebar" exact={true} component={Blogleftsidebar} />
        <Route  path="/blogrightsidebar" exact={true} component={Blogrightsidebar} />
        {/* Contact us */}
