...
const Process = () => {
   return (
    <section className="procces pt-0">
    <div className="container-fluid p-0">
       <div className="row no-gutters">
          <div className="col-xl-4 col-lg-12 pt-bg-dark">
             <div className="pt-process-step pt-process-1">
                <div className="pt-process-info">
                   <h3 className="pt-process-title text-white">Research &amp; Analysis</h3>
                   <p className="pt-process-description text-white">It is a long established fact that a reader will be distracted by
                      the readable content of a page when looking at its layout. 
                   </p>
                </div>
                <div className="pt-btn-container">
                   <a className="pt-button pt-btn-link" href="/">
          ...
          <div className="col-xl-4 col-lg-12">
             <div className="pt-process-step pt-process-1 pt-bg-primary">
                <div className="pt-process-info">
