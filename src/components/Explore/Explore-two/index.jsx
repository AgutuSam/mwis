...
const Explore = () => {
    return(
    <>
         <section className="explore-feature pt-bg-dark wow animate__fadeIn" data-wow-delay="0.2s">
         <div className="pt-bg-overley1" style={{backgroundImage: "url('images/bg/01.png')"}}></div>
         <div className="container">
            <div className="row">
               <div className="col-xl-6 mb-4 mb-lg-0">
                  <div className="about-img-block">
                     <img className="img-fluid about-img-0" src="images/AliceWahome.jpg" alt="background_image"/>
               ...
               <div className="col-xl-6  d-flex align-items-center">
                  <div className="pt-section-title-box text-xl-left text-md-center text-center mb-0">
                     ...
                     <h2 className="pt-section-title text-white">Message from the CS</h2>
